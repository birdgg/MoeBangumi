...
mod openapi_paths {
    ...
    #[doc(hidden)]
    pub use super::search::{__path_find_metadata, __path_get_metadata_detail, __path_search_bgmtv, __path_search_metadata, __path_search_metadata_all, __path_search_mikan, __path_search_tmdb};
    #[doc(hidden)]
